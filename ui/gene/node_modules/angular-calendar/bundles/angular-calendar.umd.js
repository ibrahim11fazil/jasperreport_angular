(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('positioning'), require('calendar-utils'), require('@angular/animations'), require('@angular/common'), require('angular-resizable-element'), require('angular-draggable-droppable'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-calendar', ['exports', 'positioning', 'calendar-utils', '@angular/animations', '@angular/common', 'angular-resizable-element', 'angular-draggable-droppable', '@angular/core'], factory) :
    (factory((global['angular-calendar'] = {}),global.positioning,global.calendarUtils,global.ng.animations,global.ng.common,global['angular-resizable-element'],global['angular-draggable-droppable'],global.ng.core));
}(this, (function (exports,positioning,calendarUtils,animations,common,angularResizableElement,angularDraggableDroppable,core) { 'use strict';
