...
import { TacActivation, CancelCourse } from 'app/models/tac-activation';
...
import { EmpData } from 'app/models/emp-data';

import { SeatCapacity, SeatCapacityCheck } from 'app/models/seat-capacity';
...
// }
  ...
  // getParticipantData(activation:TacActivation):Observable<Object> {
  //   return this.httpClient.post(GET_PARTICIPANT_DATA,activation);
  // }
  cancelCourse(activation:CancelCourse):Observable<Object> {
    return this.httpClient.post(CANCEL_COURSE,activation);
  }
  getMawaredData(mawaredData:EmpData):Observable<Object> {

    return this.httpClient.post(GET_MAWARED_DATA,mawaredData);
  }
  enrollParticipantForCourse(directEmpData:EmpData):Observable<Object> {

    return this.httpClient.post(DIRECT_ENROLL_PARTICIPANT,directEmpData);
  }
  deleteParticipantForCourse(directEmpData:EmpData):Observable<Object> {

    return this.httpClient.post(DELETE_PARTICIPANT,directEmpData);
  }
  ...
  getMyTaskCount():Observable<Object> {
    return this.httpClient.post(TASK_COUNT,null);
  }
  ...
  //check seats
  checkforSeats(input:SeatCapacityCheck):Observable<Object>{
    return this.httpClient.post(CHECK_FOR_SEATS,input);
  }
  ...
  getdirectEnrollEmployeeSmartProfileBasicInfo(input:SmartProfileUserRequestModel){
    return this.httpClient.post(GET_DIRECTENROLL_EMPLOYEE_BASIC_INFO,input);
  }
  ...
  getfullJobCard(input:SmartProfileUserRequestModel){
    return this.httpClient.post(GET_FULL_JOBCARD,input);
  }
  ...
  GetEmpCourseHistoricalData(input:SmartProfileUserRequestModel){
    return this.httpClient.post(GET_EMP_COURSE_HISTORICALDATA,input);
  }

  getCoordinatorCourses():Observable<Object>{
    return this.httpClient.post(COORDINATOR_COURSES,null);
  }
  getInstructorCourses():Observable<Object>{
    return this.httpClient.post(INSTRUCTOR_COURSES,null);
  }

  getCancelRequestList():Observable<Object>{
  ...
  cancelRequestStatus(request:CancelRequest):Observable<Object>{
    return this.httpClient.post(CANCEL_REQUEST_STATUS,request);
  }
