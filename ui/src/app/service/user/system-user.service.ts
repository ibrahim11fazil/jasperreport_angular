...
export class SystemUserService {
  ...
  getPermissions(): Observable<Object> {
    return this.httpClient.post(GET_ALL_PERMISSIONS,null);
  }
  ...
  changePassword(data:PasswordRequest): Observable<Object> {
    return this.httpClient.post(UPDATE_PASSWORD,data);
  }
