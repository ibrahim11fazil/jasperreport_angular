...
export class LanguageUtil  {
    ...
    previousCourse:String=this.isArabic?"Previous Courses 1":"Previous Courses"
    currentCourse:String=this.isArabic?"Current Courses 1":"Current Courses"
    futureCourse:String=this.isArabic?"Future Courses 1":"Future Courses"
  ...
  decisionDate:String=this.isArabic ? "تاريخ القرار" : "Decision Date"
   ...
   responsibilities:String=this.isArabic? "Responsibilities 1" : "Responsibilities"
    ...
    noDataToDisplay=this.isArabic? "No Data to Display 1":"No Data to Display"
   ...
   totalMemoryUsed:String=this.isArabic ? "مساحة التخزين المستخدمة" : "Total Memory Used"
    ...
    menu_employeeRequests:String=this.isArabic ? "طلبات الموظفين" : "Employee Requests"
    ...
    menu_manageAttendance:String=this.isArabic? "Manage Attendance 1" : "Manage Attendance"
...
//Dashboard
approved_courses= this.isArabic? "Approved Courses 1" :"Approved Courses"
request_future_courses= this.isArabic? "Request Future Courses1":"Request Future Courses"
ongoing_courses= this.isArabic? "Ongoing Courses1" :"Ongoing Courses"
